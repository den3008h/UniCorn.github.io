...
$image_dir_path = $_SERVER['DOCUMENT_ROOT'] . "/file";
...
$dest_file_name = $_SERVER['DOCUMENT_ROOT']."/file/".$_FILES["file_upload"]["name"];
move_uploaded_file($tmp_file_name, $dest_file_name);
}
?>
<br><br>
<!-- Форма для удаления файла с сервера -->
<form name="file_delete" action="file.php" method="post" enctype="application/x-www-form-urlencoded">
...
?>
<br>
<a href="file.php" class="menu">reload</a>
</body>
</html>